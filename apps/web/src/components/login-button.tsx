...
export default function LoginButton() {
  ...
  return (
    <button
      onClick={handleLogin}
      className="flex items-center gap-3 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-gray-900 shadow-lg transition-all duration-150 hover:bg-gray-100 hover:shadow-xl focus-ring active:scale-95"
    >
      {/* GitHub SVG icon */}
      <svg
        className="h-5 w-5"
